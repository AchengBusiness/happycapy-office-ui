#!/usr/bin/env python3
"""状态更新工具，用于控制 HappyCapy Office UI"""
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        ...
        print("  python set_state.py researching \"搜索资料中...\"")
        print("  python set_state.py writing \"编写文档中...\"")
        print("  python set_state.py executing \"执行任务中...\"")
        sys.exit(1)
